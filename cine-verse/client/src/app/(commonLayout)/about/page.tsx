    ...
    <main className="min-h-screen bg-black text-white pt-24 pb-20">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-purple-400 text-xs font-bold tracking-widest uppercase mb-8">
              <Info className="w-4 h-4" /> About CineVerse
            </div>
            <h1 className="text-5xl md:text-7xl font-black mb-8 leading-tight tracking-tighter italic uppercase text-white">
              Redefining <br />
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12 font-medium leading-relaxed">
              CineVerse is more than just a streaming portal. It's a digital
              vortex for movie lovers, designed to bridge the gap between
              premium content and a passionate community.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="p-8 rounded-3xl bg-black border border-white/5 hover:border-purple-500/30 transition-all duration-300 group"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-4xl md:text-5xl font-black mb-8 italic uppercase tracking-tighter underline decoration-purple-500 underline-offset-8">
                Our Mission
              </h2>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl shadow-purple-500/10 border border-white/10"
            >
              <img
              ...
              <div className="absolute bottom-6 left-6 flex items-center gap-3">
                <div className="bg-purple-600 p-2 rounded-full shadow-lg shadow-purple-600/30">
                  <Film className="w-4 h-4 text-white" />
                </div>
                <span className="text-sm font-bold tracking-widest uppercase italic text-white">
      ...
      <section className="py-20 text-center border-t border-white/5">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-black italic uppercase italic mb-8">
            Join the CineVerse Revolution
          </h2>
          <div className="flex justify-center gap-8">
            <Link
              href="https://github.com/alaminjim/cineVerse"
              className="flex items-center gap-2 text-gray-500 hover:text-white transition-all font-bold uppercase text-xs tracking-widest"
            >
            ...
            <Link
              ...
              className="flex items-center gap-2 text-gray-500 hover:text-white transition-all font-bold uppercase text-xs tracking-widest"
            >
              <Globe className="w-5 h-5" /> All Movies
            </Link>
          </div>
        </div>
      </section>
