...
import { Facebook, Twitter, Instagram, Film, Github, Youtube, Linkedin, Twitch, Star, Play, Sparkles } from "lucide-react";
    ...
    <footer className="w-full bg-[#040d21] relative overflow-hidden pt-32 pb-10">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-8 mt-[250px]">
        ...
        <div className="max-w-4xl mb-16 text-[11px] leading-relaxed text-gray-500 font-medium">
          <p className="mb-2">
            <sup className="mr-1">1</sup> This cinematic experience factor is based on data from millions of users across the globe who choose CineVerse for their daily entertainment, experiencing seamless 4K streaming and AI-powered recommendations.
          </p>
          <p className="mb-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16 text-sm">
          ...
          <div className="col-span-2 md:col-span-1 mb-8 md:mb-0">
            <Link href="/" className="flex items-center gap-2 group inline-flex hover:opacity-80 transition-opacity">
          ...
          {footerLinks.map((section, idx) => (
            <div key={idx}>
              <h4 className="text-gray-400 font-semibold mb-5">{section.title}</h4>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[12px] text-gray-500 bg-[#040d21]">
          ...
          <div className="flex items-center gap-5 text-gray-400">
            ...
            <a href="#" className="hover:text-white transition-colors" aria-label="Twitch"><Twitch className="w-4 h-4" /></a>
