        ...
        <div className="max-w-3xl mb-20">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter mb-6">
              Connect With <br />{" "}
              <span className="text-purple-500">The Universe</span>
            </h1>
            <p className="text-gray-400 text-lg leading-relaxed">
              Have a question about your subscription? Found a glitch in the
              matrix? Or just want to talk about your favorite director? We're
              here for it all.
            </p>
          </motion.div>
        </div>
              ...
              <div className="relative z-10 space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest font-black text-gray-500 ml-4">
                      Full Name
                    </label>
                    <input
                      type="text"
          ...
          >
            ...
            <div className="space-y-6">
              {contactOptions.map((option, i) => (
                <div key={i} className="flex gap-5 group">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-zinc-900 border border-white/5 flex items-center justify-center shrink-0 group-hover:border-${option.color.split("-")[1]}-500/30 transition-colors`}
                  >
            ...
            <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-6">
              ...
              <div className="flex items-center gap-4 text-gray-400 hover:text-white transition-colors">
                ...
                <span className="text-sm font-medium">01705026628</span>
              </div>
              <div className="flex items-center gap-4 text-gray-400 hover:text-white transition-colors">
                <MapPin className="w-5 h-5 text-purple-400" />
                <span className="text-sm font-medium">Rajshahi,Bogura</span>
              </div>
            </div>
            ...
            <div className="p-8 rounded-[32px] bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-500/10 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-gray-500 text-sm mb-6">
                  Our CineBuddy AI is ready to assist you right now.
                </p>
